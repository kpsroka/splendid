...
import type { UiMessageProps, UiMessageDispatch } from './UiMessage';
import DismissMessageAction from '../actions/DismissMessageAction';
...
function mapDispatchToProps(dispatch):UiMessageDispatch {
  return { onDismissMessage: () => dispatch(DismissMessageAction()) };
}
