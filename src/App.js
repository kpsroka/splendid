...
const App = () => (
    <div>
        <MineBox bg_color="green" fg_color="white" >
            <ResourceBox count="1" bg_color="red" fg_color="white" />
            <ResourceBox count="2" bg_color="blue" fg_color="white" />
            <ResourceBox count="3" bg_color="darkgreen" fg_color="white" />
            <ResourceBox count="4" bg_color="black" fg_color="white" />
            <ResourceBox count="0" bg_color="white" fg_color="black" />
        </MineBox>
        <MineBoardComponent />
